...
public class CommonDatabaseReferences {
    ...
    public static DatabaseReference getM2Reference(String OTAC) {
        DatabaseReference reference = getActiveSessionReference(OTAC).child("M2").child("payload");
        return reference;
    }

    public static DatabaseReference getM3Reference(String OTAC) {
        DatabaseReference reference = getActiveSessionReference(OTAC).child("M3").child("payload");
        return reference;
    }

    public static DatabaseReference getM4Reference(String OTAC) {
        DatabaseReference reference = getActiveSessionReference(OTAC).child("M4").child("payload");
        return reference;
    }

    public static DatabaseReference getM5Reference(String OTAC) {
        DatabaseReference reference = getActiveSessionReference(OTAC).child("M5").child("payload");
        return reference;
    }
